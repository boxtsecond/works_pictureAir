...
var PhotoSchema=new mongoose.Schema(
    ...
    mobileEditActive:{type: Boolean, default: true}, //已经加模板手机端不能编辑
    //pp或ep的信息
    customerIds: [
        mongoose.Schema(
        {
    ...
    orderHistory: [
        { //购买信息
            customerId: String,  //pp或ep的code
            productId: String,  //对应产品Id（照片，杯子，钥匙扣）
            prepaidId: String,  //pp+的code
            userId: String,  //用户Id
            createdOn: Date  //创建时间
    ...
    originalInfo: { //原图信息
        originalName: {type: String, required: true, index: true}, //原图名称  s
...
module.exports=mongoosedb.model('Photo',PhotoSchema);