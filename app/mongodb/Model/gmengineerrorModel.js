/**
 * Created by meteor on 14-9-28.
 */
var collectionname='gmengineerror';
var mongoose=require('mongoose');
var db=require('../mongodb.js');
//var dbconfig=require('../config.js');
var SchemaInfo=require('../Schema/'+collectionname+'Schema');
var Schema = new mongoose.Schema(SchemaInfo.config,SchemaInfo.options);
//var entity=require('../Entity/'+collectionname+'.js');
//##################实例方法##################
...
//module.exports.insert=function(entity)
//{
//    console.log('################');
//    // entity._id= mongoose.Schema.Types.objectId;
//    //console.log(entity.__id);
//  //
//  //  entity._id='54239537a8297eff28000001'
//    model.create(entity, function(error){
//        if(error) {
//            console.log(error);
//        } else {
